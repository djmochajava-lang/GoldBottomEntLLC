...
const DataStore = {
  ...
  seedIfEmpty() {
    ...
    // One-time migration: contracts schema v2 — name/parties → title/partyA/partyB
    if (!Utils.storage.get('gbe-contracts-v2')) {
      this.seedContracts();
      Utils.storage.set('gbe-contracts-v2', '2026-06-25');
      console.log('📄 DataStore: contracts schema migrated to v2 (title/partyA/partyB)');
    }
    ...
    if (Utils.storage.get(this.KEYS.ROSTER)) {
      ...
      var hasBandMembers = roster.some(function(t){ return t.category === 'band_member'; });
      if (!hasBandMembers) {
        var bandMembers = [
          { id:'talent-005', name:'DJ Mocha Java', category:'band_member', genre:'MC / DJ / Production / Rap Vocals', status:'active', email:'[EMAIL]', phone:'[PHONE]', bio:'Owner of Gold Bottom Productions & Studios in Washington, D.C. The energy behind the booth, the mic, and the stage. Band manager for Soul Society.', website:'', contractStart:'', contractEnd:'', commission:0, image:'', rateType:'flat', standardRate:0, minimumRate:0, depositPercent:0, travelRadius:'National', availabilityStatus:'available', riderNeeds:'', noGoZones:'', createdAt:'2026-03-26T00:00:00Z', updatedAt:'2026-03-26T00:00:00Z' },
          { id:'talent-006', name:'Eugene Chapman', category:'band_member', genre:'Saxophone', status:'active', email:'[EMAIL]', phone:'[PHONE]', bio:'Morgan State alum who has shared stages with P-Funk, The Temptations, and Erykah Badu. Eight NAACP Theatre Award nominations.', website:'', contractStart:'', contractEnd:'', commission:0, image:'', rateType:'flat', standardRate:0, minimumRate:0, depositPercent:0, travelRadius:'', availabilityStatus:'available', riderNeeds:'', noGoZones:'', createdAt:'2026-03-26T00:00:00Z', updatedAt:'2026-03-26T00:00:00Z' },
          { id:'talent-007', name:'Kevin Robinson', category:'band_member', genre:'Lead Guitar', status:'active', email:'[EMAIL]', phone:'[PHONE]', bio:'Maryland Entertainment Hall of Fame inductee (2017). Sheffield Institute trained, known as "The Maestro" for his commanding fretwork.', website:'', contractStart:'', contractEnd:'', commission:0, image:'', rateType:'flat', standardRate:0, minimumRate:0, depositPercent:0, travelRadius:'', availabilityStatus:'available', riderNeeds:'', noGoZones:'', createdAt:'2026-03-26T00:00:00Z', updatedAt:'2026-03-26T00:00:00Z' },
          { id:'talent-008', name:'Jimmy Carney', category:'band_member', genre:'Drums & Percussion', status:'active', email:'[EMAIL]', phone:'[PHONE]', bio:'Camp Springs, MD percussionist who also plays with We Are One (Maze & Frankie Beverly tribute) and The Positive Force.', website:'', contractStart:'', contractEnd:'', commission:0, image:'', rateType:'flat', standardRate:0, minimumRate:0, depositPercent:0, travelRadius:'', availabilityStatus:'available', riderNeeds:'', noGoZones:'', createdAt:'2026-03-26T00:00:00Z', updatedAt:'2026-03-26T00:00:00Z' },
          { id:'talent-009', name:'Kevin Walker', category:'band_member', genre:'Bass', status:'active', email:'[EMAIL]', phone:'[PHONE]', bio:'Soul Society bassist.', website:'', contractStart:'', contractEnd:'', commission:0, image:'', rateType:'flat', standardRate:0, minimumRate:0, depositPercent:0, travelRadius:'', availabilityStatus:'available', riderNeeds:'', noGoZones:'', createdAt:'2026-03-26T00:00:00Z', updatedAt:'2026-03-26T00:00:00Z' }
        ];
        this._save(this.KEYS.ROSTER, roster.concat(bandMembers));
        console.log('🎸 DataStore: migrated Soul Society band members into roster');
      }
  ...
  seedRoster() {
    this._save(this.KEYS.ROSTER, [
      ...
      // Soul Society Band Members
      {
        ...
        email: '[EMAIL]',
        phone: '[PHONE]',
        bio: 'Owner of Gold Bottom Productions & Studios in Washington, D.C. The energy behind the booth, the mic, and the stage. Band manager for Soul Society.',
        website: '',
        contractStart: '',
        contractEnd: '',
        commission: 0,
      ...
      },
      {
        ...
        email: '[EMAIL]',
        phone: '[PHONE]',
        bio: 'Morgan State alum who has shared stages with P-Funk, The Temptations, and Erykah Badu. Eight NAACP Theatre Award nominations.',
        website: '',
        contractStart: '',
        contractEnd: '',
        commission: 0,
      ...
      },
      {
        ...
        email: '[EMAIL]',
        phone: '[PHONE]',
        bio: 'Maryland Entertainment Hall of Fame inductee (2017). Sheffield Institute trained, known as "The Maestro" for his commanding fretwork.',
        website: '',
        contractStart: '',
        contractEnd: '',
        commission: 0,
      ...
      },
      {
        ...
        name: 'Jimmy Carney',
        category: 'band_member',
        genre: 'Drums & Percussion',
        status: 'active',
        email: '[EMAIL]',
        phone: '[PHONE]',
        bio: 'Camp Springs, MD percussionist who also plays with We Are One (Maze & Frankie Beverly tribute) and The Positive Force.',
        website: '',
        contractStart: '',
        contractEnd: '',
        commission: 0,
  ...
  seedContracts() {
    this._save(this.KEYS.CONTRACTS, [
      {
        id: 'contract-001',
        title: 'L.A. Young — Artist Management Agreement',
        type: 'management',
        partyA: 'Gold Bottom Ent LLC',
        partyB: 'L.A. Young',
        status: 'signed',
      ...
      {
        id: 'contract-002',
        title: 'Venue Booking — [Venue Name]',
        type: 'booking',
        partyA: 'Gold Bottom Ent LLC',
        partyB: '[Venue Name]',
        status: 'draft',
      ...
      {
        id: 'contract-003',
        title: 'Web Development — [Client Project]',
        type: 'development',
        partyA: 'Gold Bottom Ent LLC',
        partyB: '[Client Name]',
        status: 'draft',
  ...
  seedEvents() {
    this._save(this.KEYS.EVENTS, [
      { id: 'evt-001', title: '[SAMPLE] Venue Show', date: '2026-06-15T20:00:00', endDate: '2026-06-15T23:00:00', type: 'gig', venue: '[Venue Name]', notes: 'Full band, 2 sets. Rider confirmed by venue.', color: '#d4a017', createdAt: '2026-02-01T00:00:00Z', updatedAt: '2026-06-25T00:00:00Z' },
  ...
  seedMerch() {
    this._save(this.KEYS.MERCH_PRODUCTS, [
      // "I _____ because I am human" Trademark Collection — 6 designs x 2 types = 12 products
      { id: 'merch-001', name: 'I Sing Because I Am Human\u2122 \u2014 T-Shirt', price: 29.99, category: 'apparel', type: 't-shirt', design: 'I Sing Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/sing-tshirt.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','White','Gold'], description: 'L.A. Young\'s signature phrase. A declaration of authenticity in the age of algorithms. Premium cotton tee with bold typography.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-002', name: 'I Sing Because I Am Human\u2122 \u2014 Hoodie', price: 49.99, category: 'apparel', type: 'hoodie', design: 'I Sing Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/sing-hoodie.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','Charcoal'], description: 'L.A. Young\'s signature phrase on a heavyweight fleece hoodie. The voice behind the music, the human behind the voice.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-003', name: 'I Dance Because I Am Human\u2122 \u2014 T-Shirt', price: 29.99, category: 'apparel', type: 't-shirt', design: 'I Dance Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/dance-tshirt.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','White','Gold'], description: 'For everyone who moves to the rhythm. Movement is the body\'s oldest language — and it belongs to all of us.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-004', name: 'I Dance Because I Am Human\u2122 \u2014 Hoodie', price: 49.99, category: 'apparel', type: 'hoodie', design: 'I Dance Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/dance-hoodie.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','Charcoal'], description: 'Movement is human. Heavyweight fleece hoodie with the dance declaration.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-005', name: 'I Create Because I Am Human\u2122 \u2014 T-Shirt', price: 29.99, category: 'apparel', type: 't-shirt', design: 'I Create Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/create-tshirt.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','White','Gold'], description: 'For painters, writers, builders, and dreamers. Creation is what makes us human.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-006', name: 'I Create Because I Am Human\u2122 \u2014 Hoodie', price: 49.99, category: 'apparel', type: 'hoodie', design: 'I Create Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/create-hoodie.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','Charcoal'], description: 'The creative\'s declaration. Heavyweight fleece hoodie for every maker.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-007', name: 'I Play Because I Am Human\u2122 \u2014 T-Shirt', price: 29.99, category: 'apparel', type: 't-shirt', design: 'I Play Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/play-tshirt.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','White','Gold'], description: 'For musicians and performers. Every note played is proof of life.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-008', name: 'I Play Because I Am Human\u2122 \u2014 Hoodie', price: 49.99, category: 'apparel', type: 'hoodie', design: 'I Play Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/play-hoodie.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','Charcoal'], description: 'The musician\'s declaration. Heavyweight fleece hoodie for those who play.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-009', name: 'I Dream Because I Am Human\u2122 \u2014 T-Shirt', price: 29.99, category: 'apparel', type: 't-shirt', design: 'I Dream Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/dream-tshirt.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','White','Gold'], description: 'Inspiration starts with a dream. The most aspirational piece in the collection.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-010', name: 'I Dream Because I Am Human\u2122 \u2014 Hoodie', price: 49.99, category: 'apparel', type: 'hoodie', design: 'I Dream Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/dream-hoodie.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','Charcoal'], description: 'Dream boldly. Heavyweight fleece hoodie with the dreamer\'s declaration.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-011', name: 'Because I Am Human\u2122 \u2014 T-Shirt', price: 29.99, category: 'apparel', type: 't-shirt', design: 'Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/core-tshirt.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','White','Gold'], description: 'The core mark. No verb needed — the statement speaks for itself. Bold, minimal, universal.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
      { id: 'merch-012', name: 'Because I Am Human\u2122 \u2014 Hoodie', price: 49.99, category: 'apparel', type: 'hoodie', design: 'Because I Am Human\u2122', status: 'active', inventory: 0, printOnDemand: true, shopifyId: '', image: 'images/merch/core-hoodie.jpg', sizes: ['S','M','L','XL','2XL'], colors: ['Black','Charcoal'], description: 'The core mark on heavyweight fleece. No verb, no explanation — just truth.', createdAt: '2026-03-30T00:00:00Z', updatedAt: '2026-03-30T00:00:00Z' },
    ]);
  ...
  seedITCredentials() {
    this._save(this.KEYS.IT_CREDENTIALS, [
      ...
      { id: 'cred-002', name: 'Firebase Console', category: 'database', loginUrl: 'https://console.firebase.google.com/', username: '[YOUR GOOGLE EMAIL]', password: '[GOOGLE ACCOUNT]', apiKey: '[RETIRED — firebaseConfig was removed from js/config.js in the Firebase exit]', notes: 'RETIRED (fbexit 2026-07): auth + data moved to Supabase. Legacy project goldbottoment kept for account/console history only.', createdAt: '2026-02-20T00:00:00Z', updatedAt: '2026-02-20T00:00:00Z' },
  ...
  seedITServers() {
    this._save(this.KEYS.IT_SERVERS, [
      ...
      { id: 'srv-004', name: 'Firebase', provider: 'Google', category: 'database', purpose: 'RETIRED (fbexit 2026-07) — replaced by Supabase (auth + public read cache)', url: 'https://console.firebase.google.com', ip: '', status: 'active', monthlyCost: 0, billingCycle: 'free', renewalDate: '', notes: 'Legacy project goldbottoment — decommissioned in the Firebase exit; no client or server code references it.', createdAt: '2026-02-20T00:00:00Z', updatedAt: '2026-02-20T00:00:00Z' },
